...
class Adeptrix:
        ...
        for num in range(0, rowcount2):
            ...
            for numtwo in range(0, 2000):
                if(numthree < rowcount):
                    ...
                    numthree += 1
            t = threading.Thread(target=Adeptrix.controllargeneg, args = [data]).start()
    ...
    def controllargeneg(data):
        ...
        testmain = []
        testmain = Adeptrix.localmaxneg(subdata, data)        
        test = testmain[1]
        if(test): 
...
class Gui:
    ...
    def begin():        
        ...
        minintens = Entry(Gui.window, textvar= Gui.minintens, width = 30)
        Gui.minintens.set("Set Minimum Intensity Here")
        minintens.pack()
        minmass = Entry(Gui.window, textvar= Gui.minmass, width = 30)
        Gui.minmass.set("Set Minimum m/z Here")
        minmass.pack()
        maxmass = Entry(Gui.window, textvar= Gui.maxmass, width = 30)
